    ...
    <header>
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">SSCT</a>
        ...
        <div class="exemplo">
                ...
                <span>
                    <a href="{{route('relatorio.gerar-pdf')}}" class="btn btn-warning btn-sm">Gerar PDF</a>
                </span>
...
<body>
  ...
  <div class="container px-4 px-lg-5">
    ...
    <h1 class="mt-3"><strong>SSCT</strong></h1>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav ms-auto my-2 my-lg-0">
        ...
        <li class="nav-item"><a class="nav-link" href="#choose">Porquê Nós?</a></li>
        ...
        @auth
                        ...
                        @endauth
        <li class="nav-item">
          <button class="btn theme" onclick="toggleColorMode()"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-moon" viewBox="0 0 16 16">
                ...
                <div class="col-md-7">
                  <div class="detail-box">
                    <h1>
                      ANATA <br>
                      <span>
                        Associação Nova Aliança dos Taxistas de Angola
                      </span>
                    </h1>
                    <p>
                    ...
                    <div class="btn-box">
                      <a href="{{route('site')}}" class="btn-1"> Cadastro </a>
                      <a href="" class="btn-2">Contacto</a>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6 px-0">
          <div class="detail-box">
            ...
            Economize enquanto dirige! Nosso sistema de subvenção de combustível é a solução perfeita para taxistas preocupados com seus gastos.Maximize seus lucros com nosso sistema de subvenção de combustível exclusivo para taxistas. Economize mais, dirija mais!.
            </p>
            <div class="btn-box">
              <a href="">
              Cadastro
...
Líderes provinciais, municipais e distritais iniciam formação sobre gestão de transportes tráfego e mobilidade urbana. 
        ...
        <div class="col-md-4">
          ...
          c10.095-0.01,18.276-8.191,18.286-18.286V283.429C475.419,273.334,467.238,265.153,457.143,265.143z" />
            ...
            <div class="detail-box">
              ...
              <p>
              A UNITEL e os taxistas da Taxion, grupo adstrito a Associação Nova Aliança dos Taxistas de Angola (ANATA) e a Cooperativa de Inovação e Inclusão Social dos Trabalhadores Informais (CIIST), firmaram uma parceria para promover e facilitar o pagamento.
              </p>
        ...
        <div class="col-md-4">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <p>
              Chama-se "Taxi On" e é uma aplicação dedicada a quem recorre a este meio de transporte. Para além de permitir reserva e aluguer de viaturas, a app disponibiliza o selo de credenciamento do taxista, sendo que em caso de acidente de viação.
              </p>
        ...
        <div class="col-md-4">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <p>
              Os dados pessoais do taxista geralmente incluem informações básicas e identificativas.Nome,
        ...
        <div class="col-md-4">
          ...
          c10.095-0.01,18.276-8.191,18.286-18.286V283.429C475.419,273.334,467.238,265.153,457.143,265.143z" />
            ...
            <div class="detail-box">
              ...
              <p>
              O título do veículo, também conhecido como documento de propriedade, é um certificado legal que comprova quem é o proprietário registrado de um veículo. Geralmente, contém informações importantes, como o nome e endereço...
              </p>
        ...
        <div class="col-md-4">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <p>
              "livrete de viratura"pode ser um termo usado para descrever o documento de registro de um veículo, que contém informações sobre o proprietário, características do veículo, registros de manutenção, entre outros detalhes.
              </p>
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="info_logo">
            ...
            <p>
              Aumente seus lucros sem sacrificar sua jornada. Com nosso sistema de subvenção de combustível, você pode economizar enquanto continua dirigindo.
            </p>
          </div>
        </div>
        <div class="col-md-3">
